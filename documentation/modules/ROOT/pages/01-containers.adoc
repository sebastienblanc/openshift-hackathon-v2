...
Pensez bien à bien forker ce dépôt ! Vous allez travailler sur cette application pendant les 2 prochaines journées.  
N'oubliez pas de packager votre application avant de commencer à la conteneuriser. Vous pouvez utiliser la commande Maven `mvn clean package`.
