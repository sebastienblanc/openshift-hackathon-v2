...
IMPORTANT: Il y a 2 versions différentes de l'opérateur (1 certifiée Red Hat et 1 version communautaire). Nous avons rencontré un problème avec l'opérateur certifié (en cours de résolution côté Red Hat) et il faut donc installer l'opérateur "Communautaire".
